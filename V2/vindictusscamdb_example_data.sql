...
--
-- Dumping data for table `adsense_ad_locations`
--
...
INSERT INTO `menu_entries` (`id`, `title`, `link`, `styling`, `changefreq`, `priority`) VALUES
(1, 'Home', '', '', 'always', '1.00'),
(2, 'Home', '#banner', '', 'always', '1.00'),
(3, 'Scammers', '#scammers', '', 'always', '1.00'),
(4, 'Report a Player', '#report', '', 'never', '0.70'),
(5, 'Trusted Players', '#trusted', '', 'never', '0.10'),
(6, 'FAQ', '#faq', '', 'always', '1.00'),
(7, 'Changelog', '#changelog', '', 'always', '1.00'),
(8, 'Contact Us', '#contact', '', 'never', '0.10');
...
--
-- Dumping data for table `scammer_activity`
--
...
INSERT INTO `settings` (`id`, `title`, `url`, `keywords`, `description`, `author`, `version`, `vers_major`, `vers_minor`, `beta`, `captcha_key`, `captcha_secret`, `captcha_enabled`, `analytics_code`, `ad_spots_enabled`) VALUES
(1, 'Scam Database', 'http://yoursite.com/', 'keywords, related, to, your, web, site', 'This is a description of your website.', 'This is you.', '2.0 RC1', 2, 0, 1, '', '', 1, '', 0);
...
--
-- Dumping data for table `verified_buyers`
--
...
--
-- Dumping data for table `verified_sellers`
--
